...
const required = (val) => val && val.maxLength;
                ...
                <div className="row row-content">
                   <div className="col-12">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={this.form1}>
                             <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        model=".firstname"
                                        show="touched"
                                        messages={{minLength:"Must be greater than 2 char", maxLength:"15 char" }} />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        model=".email"
                                        show="touched"
                                        messages={{validEmail:"incorrect email"}} />
                                </Col>                        
                            </Row>
